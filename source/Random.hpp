...
static KOKKOS_INLINE_FUNCTION uint64_t rotl(const uint64_t x, int k) {
    return (x << k) | (x >> (64 - k));
}
...
KOKKOS_INLINE_FUNCTION uint64_t next(Xoro256State* state) {
    uint64_t* s = state->s;
...
KOKKOS_INLINE_FUNCTION void jump(Xoro256State* state) {
...
KOKKOS_INLINE_FUNCTION void long_jump(Xoro256State* state) {
...
static KOKKOS_INLINE_FUNCTION uint32_t rotl(const uint32_t x, int k) {
    return (x << k) | (x >> (32 - k));
}
...
KOKKOS_INLINE_FUNCTION uint32_t next(Xo128State* state) {
    uint32_t* s = state->s;
...
KOKKOS_INLINE_FUNCTION void jump(Xo128State* state) {
...
KOKKOS_INLINE_FUNCTION void long_jump(Xo128State* state) {
